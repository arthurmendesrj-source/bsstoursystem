...
import { Inbox, Send, FileText, AlertOctagon, Trash2, Star, Tag, RefreshCw, Search, Paperclip, Mail, ChevronLeft, ArrowLeft, Reply, Forward, Archive, MailOpen } from "lucide-react";
